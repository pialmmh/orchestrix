...
public class RHEL8IpForwardAutomation extends AbstractIpForwardAutomation {

    public RHEL8IpForwardAutomation(boolean useSudo, boolean enableIpv4, boolean enableIpv6, boolean makePersistent) {
        super(LinuxDistribution.RHEL_8, useSudo, enableIpv4, enableIpv6, makePersistent);
    }
    ...
    public boolean makePersistent(SshDevice device) throws Exception {
        // Implementation specific to RHEL8
