...
public class Ubuntu2204SnapInstallAutomation extends AbstractLinuxAutomation implements SnapInstallAutomation {

    public Ubuntu2204SnapInstallAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Ubuntu2204 SnapInstallAutomation";
    }

    @Override
    public String getDescription() {
        return "Snap package management for Ubuntu2204";
    }
}
