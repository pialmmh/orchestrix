...
public class DefaultLxdBridgeConfigureAutomation extends AbstractLinuxAutomation implements LxdBridgeConfigureAutomation, AbstractLinuxAutomation.DefaultImplementation {

    public DefaultLxdBridgeConfigureAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Default LxdBridgeConfigureAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD bridge configuration for default Linux distributions";
    }
}
