...
public class DefaultLxdInstallerAutomation extends AbstractLinuxAutomation implements LxdInstallerAutomation, AbstractLinuxAutomation.DefaultImplementation {

    public DefaultLxdInstallerAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Default LxdInstallerAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD installation for default Linux distributions";
    }
}
