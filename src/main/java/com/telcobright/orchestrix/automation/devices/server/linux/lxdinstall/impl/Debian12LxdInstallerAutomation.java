...
public class Debian12LxdInstallerAutomation extends AbstractLinuxAutomation implements LxdInstallerAutomation {

    public Debian12LxdInstallerAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Debian12 LxdInstallerAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD installation for Debian12";
    }
}
