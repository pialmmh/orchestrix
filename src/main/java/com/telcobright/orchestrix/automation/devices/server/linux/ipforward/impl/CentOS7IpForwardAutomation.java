...
public class CentOS7IpForwardAutomation extends AbstractIpForwardAutomation {

    public CentOS7IpForwardAutomation(boolean useSudo, boolean enableIpv4, boolean enableIpv6, boolean makePersistent) {
        super(LinuxDistribution.CENTOS_7, useSudo, enableIpv4, enableIpv6, makePersistent);
    }
    ...
    public boolean makePersistent(SshDevice device) throws Exception {
        // Implementation specific to CentOS7
