...
public class RHEL8LxdInstallerAutomation extends AbstractLinuxAutomation implements LxdInstallerAutomation {

    public RHEL8LxdInstallerAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "RHEL8 LxdInstallerAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD installation for RHEL8";
    }
}
