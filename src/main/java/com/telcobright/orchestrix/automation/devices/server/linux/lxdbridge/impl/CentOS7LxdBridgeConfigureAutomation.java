...
public class CentOS7LxdBridgeConfigureAutomation extends AbstractLinuxAutomation implements LxdBridgeConfigureAutomation {

    public CentOS7LxdBridgeConfigureAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "CentOS7 LxdBridgeConfigureAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD bridge configuration for CentOS7";
    }
}
