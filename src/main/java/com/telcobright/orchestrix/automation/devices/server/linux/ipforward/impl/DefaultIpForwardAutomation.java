...
public class DefaultIpForwardAutomation extends AbstractIpForwardAutomation implements AbstractLinuxAutomation.DefaultImplementation {

    public DefaultIpForwardAutomation(boolean useSudo, boolean enableIpv4, boolean enableIpv6, boolean makePersistent) {
        super(LinuxDistribution.UNKNOWN, useSudo, enableIpv4, enableIpv6, makePersistent);
    }
    ...
    public boolean makePersistent(SshDevice device) throws Exception {
        // Implementation specific to Default
