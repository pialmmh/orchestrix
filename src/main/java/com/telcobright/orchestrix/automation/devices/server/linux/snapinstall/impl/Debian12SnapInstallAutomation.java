...
public class Debian12SnapInstallAutomation extends AbstractLinuxAutomation implements SnapInstallAutomation {

    public Debian12SnapInstallAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Debian12 SnapInstallAutomation";
    }

    @Override
    public String getDescription() {
        return "Snap package management for Debian12";
    }
}
