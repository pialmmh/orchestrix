...
public class Debian12LxdBridgeConfigureAutomation extends AbstractLinuxAutomation implements LxdBridgeConfigureAutomation {

    public Debian12LxdBridgeConfigureAutomation(boolean useSudo) {
        super(LinuxDistribution.DEBIAN_12, useSudo);
    }
    ...
    public String getName() {
        return "Debian12 LxdBridgeConfigureAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD bridge configuration for Debian12";
    }
}
