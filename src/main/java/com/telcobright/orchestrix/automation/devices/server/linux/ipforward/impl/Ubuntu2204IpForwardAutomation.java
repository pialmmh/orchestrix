...
public class Ubuntu2204IpForwardAutomation extends AbstractIpForwardAutomation {

    public Ubuntu2204IpForwardAutomation(boolean useSudo, boolean enableIpv4, boolean enableIpv6, boolean makePersistent) {
        super(LinuxDistribution.UBUNTU_2204, useSudo, enableIpv4, enableIpv6, makePersistent);
    }
    ...
    public boolean makePersistent(SshDevice device) throws Exception {
        // Implementation specific to Ubuntu2204
