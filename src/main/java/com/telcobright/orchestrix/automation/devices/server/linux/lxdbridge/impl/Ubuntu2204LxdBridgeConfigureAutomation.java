...
public class Ubuntu2204LxdBridgeConfigureAutomation extends AbstractLinuxAutomation implements LxdBridgeConfigureAutomation {

    public Ubuntu2204LxdBridgeConfigureAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "Ubuntu2204 LxdBridgeConfigureAutomation";
    }

    @Override
    public String getDescription() {
        return "LXD bridge configuration for Ubuntu2204";
    }
}
