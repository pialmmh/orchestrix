...
public class CentOS7SnapInstallAutomation extends AbstractLinuxAutomation implements SnapInstallAutomation {

    public CentOS7SnapInstallAutomation(boolean useSudo) {
    ...
    public String getName() {
        return "CentOS7 SnapInstallAutomation";
    }

    @Override
    public String getDescription() {
        return "Snap package management for CentOS7";
    }
}
