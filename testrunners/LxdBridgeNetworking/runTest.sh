...
# LXD Bridge Networking Automation Test Runner
# ============================================
...
echo "========================================="
echo "LXD Bridge Networking Automation Test"
echo "========================================="
...
TEST_CLASS="target/test-classes/testrunners/LxdBridgeNetworking/TestLxdBridgeNetworkingAutomation.class"
...
# Run the test
echo "Running test with configuration: $(basename $CONFIG_FILE)"
echo "-----------------------------------------"
