...
if [ "${BUILD_TYPE:-base}" = "base" ]; then
    ...
    sudo mvn exec:java \
        -Dexec.mainClass="com.telcobright.orchestrix.automation.containers.quarkus.QuarkusBaseContainerBuilder" \
    ...
    sudo mvn exec:java \
        -Dexec.mainClass="com.telcobright.orchestrix.automation.containers.quarkus.QuarkusAppContainerBuilder" \
        -Dexec.args="$CONFIG_FILE" \
        -Dexec.classpathScope=compile
fi
