...
# User: "v.1"
# AI: Creates images/containers/lxc/go-id-alpine/ with binary from v.1
```
...
│  Location: images/containers/lxc/, images/containers/docker/, etc.                │
├─────────────────────────────────────────────────────────────┤
...
```
Understanding:
  - Create LXC Alpine container: images/containers/lxc/go-id-alpine/
...
```
Created: images/containers/lxc/go-id-alpine/
...
cd images/containers/lxc/go-id-alpine
./buildGoIdAlpine.sh
```
...
7. **After confirmation:**
   ...
   - Create in appropriate location (images/containers/lxc/, images/containers/docker/, etc.)
...
AI: Container ready at images/containers/lxc/go-id-alpine/
```
...
**Before:**
```
images/containers/lxc/go-id/               # Debian 12, builds Go inside
...
images/containers/lxc/go-id-alpine/        # Alpine, copies binary
